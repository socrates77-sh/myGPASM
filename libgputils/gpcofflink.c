                                ...
                                struct symbol_table *logical_sections)
{
  ...
  while (1)
  {
                       ...
                       current->size, &current_shadow_address, &current_size) == 1)
    {
      ...
      _set_used(m, 0, current_shadow_address, current->size);
...

{
  ...
  next_pass:
    ...
    if (success == 1)
    {
      ...
      _set_used(m, 0, smallest_shadow_address, size);
          ...
          if (found == 1)
          {
            ...
            else
            {
              ...
              _set_used(m, object->class->org_to_byte_shift,
                        current_shadow_address, current_size);
                       ...
                       gp_reloc_type *relocation)
{
  ...
  case RELOCT_CALL:
    ...
    break;
  case RELOCT_LGOTO:
    data = (class->reloc_goto(value)) >> 8;
    break;
  case RELOCT_LGOTO2:
    data = (class->reloc_goto(value)) & 0xff;
    break;
  case RELOCT_GOTO:
