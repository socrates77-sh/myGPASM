...
enum insn_class {
  ...
  INSN_CLASS_LIT10,     /* bits 9:0 contain an 10 bit literal          */
  INSN_CLASS_IMPLICIT1,  /* instruction has no variable bits at all, without check option      */
  INSN_CLASS_OPF9,      /* bits 8:0 contain a register address          */
  INSN_CLASS_B9,        /* as for OPF9, but bits 11:9 have bit number    */
  INSN_CLASS_OPF3,      /* bits 2:0 contain a register address          */
  INSN_CLASS_LIT16,      /* for lgoto          */
  INSN_CLASS_LIT11L,      /* for lgoto of MC31P5130         */
  INSN_CLASS_OPF6,      /* bits 5:0 contain a register address          */
  INSN_CLASS_B6,        /* as for OPF6, but bits 8:6 have bit number    */
  INSN_CLASS_LIT3,      /* for iosw, iosr         */
  INSN_CLASS_LIT12      /* bits 11:0 contain an 11 bit literal          */
};
...
extern struct insn op_sn14[];
extern const int num_op_sn14;

extern struct insn op_sn16[];
extern const int num_op_sn16;

extern struct insn op_sn16a[];
extern const int num_op_sn16a;

extern struct insn op_sn16b[];
extern const int num_op_sn16b;

extern struct insn op_sn16c[];
extern const int num_op_sn16c;

extern struct insn op_sn16d[];
extern const int num_op_sn16d;

extern struct insn op_sn16e[];
extern const int num_op_sn16e;

extern struct insn op_sn13[];
extern const int num_op_sn13;

extern struct insn op_sn13b[];
extern const int num_op_sn13b;

extern struct insn op_sn13bb[];
extern const int num_op_sn13bb;

extern struct insn op_sn13c[];
extern const int num_op_sn13c;
#endif
