...
static const yytype_uint8 yyprhs[] =
    {
        0, 0, 3, 5, 7, 8, 13, 14, 17, 20,
        23, 25, 31, 34, 36, 38, 40, 44, 46, 49,
        51, 55, 57, 59, 61, 63, 65, 67, 69, 71};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
    {
        21, 0, -1, 23, -1, 1, -1, -1, 21, 18,
        22, 23, -1, -1, 4, 24, -1, 5, 24, -1,
        3, 25, -1, 7, -1, 9, 3, 29, 30, 29,
        -1, 10, 3, -1, 11, -1, 12, -1, 3, -1,
        3, 19, 24, -1, 26, -1, 26, 25, -1, 28,
        -1, 26, 27, 28, -1, 13, -1, 3, -1, 8,
        -1, 3, -1, 8, -1, 14, -1, 15, -1, 16,
        -1, 17, -1};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
    {
        0, 139, 139, 140, 141, 141, 146, 149, 155, 161,
        167, 172, 194, 204, 216, 229, 234, 241, 246, 253,
        255, 261, 264, 269, 276, 281, 284, 284, 284, 284};
#endif
...
static const char *const yytname[] =
    {
        "\"end of file\"", "error", "$undefined", "SYMBOL", "LIBPATH",
        "LKRPATH", "PATH", "ERROR", "NUMBER", "DEFINE", "IFDEF", "ELSE", "FI",
        "'='", "'+'", "'-'", "'/'", "'*'", "'\\n'", "';'", "$accept", "program",
        "$@1", "line", "path_list", "parameter_list", "e1", "e1op", "e0",
        "macroval", "aop", 0};
#endif
...
static const yytype_uint16 yytoknum[] =
    {
        ...
        265, 266, 267, 61, 43, 45, 47, 42, 10, 59};
#endif

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
    {
        0, 20, 21, 21, 22, 21, 23, 23, 23, 23,
...
static const yytype_uint8 yydefact[] =
    {
        0, 3, 0, 0, 0, 10, 0, 0, 13, 14,
        0, 2, 22, 23, 9, 17, 19, 15, 7, 8,
        0, 12, 1, 4, 21, 18, 0, 0, 24, 25,
        0, 6, 20, 16, 26, 27, 28, 29, 0, 5,
        11};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
    {
        -1, 10, 31, 11, 18, 14, 15, 26, 16, 30,
        38};
...
static const yytype_int8 yypact[] =
    {
        1, -5, 6, 4, 4, -5, 13, 15, -5, -5,
        3, -5, -5, -5, -5, 12, -5, 5, -5, -5,
        14, -5, -5, -5, -5, -5, 6, 4, -5, -5,
        22, 23, -5, -5, -5, -5, -5, -5, 14, -5,
        -5};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
    {
        -5, -5, -5, -2, -4, 16, -5, -5, 17, 2,
        -5};
...
static const yytype_int8 yytable[] =
    {
        19, -6, 1, 22, 2, 3, 4, 17, 5, 12,
        6, 7, 8, 9, 13, 12, 20, 28, 21, -6,
        13, 23, 29, 33, 27, 24, 2, 3, 4, 39,
        5, 25, 6, 7, 8, 9, 34, 35, 36, 37,
        40, 0, 0, 32};

static const yytype_int8 yycheck[] =
    {
        4, 0, 1, 0, 3, 4, 5, 3, 7, 3,
        9, 10, 11, 12, 8, 3, 3, 3, 3, 18,
        8, 18, 8, 27, 19, 13, 3, 4, 5, 31,
        7, 15, 9, 10, 11, 12, 14, 15, 16, 17,
        38, -1, -1, 26};
...
static const yytype_uint8 yystos[] =
    {
        ...
        21, 23, 3, 8, 25, 26, 28, 3, 24, 24,
        3, 3, 0, 18, 13, 25, 27, 19, 3, 8,
        29, 22, 28, 24, 14, 15, 16, 17, 30, 23,
        29};
...
#line 162 "parse.y"
  {
    if (!state.ifdef || state.ifdef->istrue)
      execute_command((yyvsp[(1) - (2)].s), (yyvsp[(2) - (2)].p));
  }
  break;
...
#line 173 "parse.y"
  {
    ...
    if (!state.ifdef || state.ifdef->istrue)
    {
      long newval = 0, lh = (yyvsp[(3) - (5)].l), rh = (yyvsp[(5) - (5)].l);
      switch ((yyvsp[(4) - (5)].i))
      {
      case '+':
        newval = lh + rh;
      ...
      add_script_macro((yyvsp[(2) - (5)].s), newval);
    }
  }
  break;
...
#line 195 "parse.y"
  {
    ...
    ifdef->istrue = ((!state.ifdef || state.ifdef->istrue) &&
                     get_symbol(state.script_symbols, (yyvsp[(2) - (2)].s)));
    ifdef->inelse = false;
...
#line 247 "parse.y"
  {
    (yyval.p) = mk_list((yyvsp[(1) - (2)].p), (yyvsp[(2) - (2)].p));
  }
  break;
...
#line 270 "parse.y"
  {
    (yyval.p) = mk_constant((yyvsp[(1) - (1)].l));
  }
  break;
...
#line 277 "parse.y"
  {
    (yyval.l) = get_script_macro((yyvsp[(1) - (1)].s));
  }
  break;
