...
show_usage(void)
{
  ...
  */
  ...
  printf("  -e [ON|OFF], --expand [ON|OFF] Macro expansion. [ON]\n");
  ...
  printf("  -n, --dos                      Use DOS newlines in s19 file.\n");
#endif
...
assemble(void)
{
  ...
  printf("\n");
  printf("%30s: %d\n", "errors", state.num.errors);
  printf("%30s: %d\n", "warnings", state.num.warnings);
  printf("%30s: %d\n", "messages", state.num.messages);
  printf("%30s: %d\n", "warnings suppressed", state.num.warnings_suppressed);
  printf("%30s: %d\n", "messages suppressed", state.num.messages_suppressed);
  printf("\n");
